...
// Login
//GJ
//router.get("/user/login", (req, res) => { //for dev
router.get("/user/login", csrfProtection, (req, res) => {
    //res.render("users/login"); //for dev
    //GJ
    res.render("users/login", {csrfToken: req.csrfToken()}); //for deploy
});

router.post(
    "/user/login",
    //GJ
    csrfProtection, //fro deploy GJ
...
router.get("/user/logout", (req, res, next) => {
    ...
    req.logout(function(err) {
      ...
      res.redirect('/'); //Good
      //res.redirect("back"); //Operates anyway
      //res.redirect('back'); //Operates anyway
    });
});
